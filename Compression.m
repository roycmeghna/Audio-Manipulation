...
figure(3)
subplot(4,1,1)
specgram(data), title('Original Waveform');
subplot(4,1,2)
specgram(Compressed2), title('Compression Factor 2');
subplot(4,1,3)
specgram(Compressed4), title('Compression Factor 4');
subplot(4,1,4)
specgram(Compressed8), title('Compression Factor 8');
